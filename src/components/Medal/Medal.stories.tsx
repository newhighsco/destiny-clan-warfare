...
export const List = {
  ...
  args: {
    medals: [
      ...
      { name: 'Nonexistent', tier: 2, count: 5 },
      { name: 'Nonexistent', tier: 2, count: 1 },
      { name: 'The best of the best', tier: 3, count: 1 },
      { name: 'The best of the best', tier: 3, count: 5 },
      { name: 'Nonexistent', tier: 3, count: 5 },
      { name: 'Nonexistent', tier: 3, count: 1 },
