          ...
          bungieApi(`/Destiny2/Milestones`)
            .then(({ data }) => {
              ...
              sourceSucceed(
                task,
                timer,
                `bungie api status: ${parsed.apiStatus.bungieStatus}`,
                resolve
              )
            })
            .catch(err => {
      ...
      task: (ctx, task) =>
        new Promise((resolve, reject) => {
          ...
          const parseMemberIcon = path => {
            if (
              path &&
              path !== `${avatarUrl}${constants.bungie.defaultAvatarIcon}`
            ) {
          ...
          api(`Leaderboard/GetClanLeaderboard`)
            .then(({ data }) => {
              ...
              sourceSucceed(
                task,
                timer,
                `current clan leaderboard: ${data.length}`,
                resolve
              )
            })
            .catch(err => {
          ...
          api(`Leaderboard/GetPreviousClanLeaderboard`)
            .then(({ data }) => {
              ...
              sourceSucceed(
                task,
                timer,
                `previous clan leaderboard: ${leaderboardList.length}`,
                resolve
              )
            })
            .catch(err => {
            ...
            .then(({ data }) => {
              ...
              sourceSucceed(
                ...
                [
                  ...
                  `match history limit: ${matchHistorySize}`
                ],
                resolve
              )
            })
