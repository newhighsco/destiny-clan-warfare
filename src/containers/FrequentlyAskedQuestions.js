    ...
    return (
      <PageContainer meta={meta}>
        <Card>
          ...
          <Prose>
            <h2><a id="what" href="#what" className="anchor" />What is {constants.meta.name}?</h2>
            ...
            <h2><a id="enrollment" href="#enrollment" className="anchor" />How do I enroll into {constants.meta.name}?</h2>
            ...
            <h3><a id="strikes" href="#strikes" className="anchor" />How do I earn points in Strikes?</h3>
            ...
            <h3><a id="raids" href="#raids" className="anchor" />How do I earn points in Raids?</h3>
