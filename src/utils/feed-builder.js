...
module.exports = (route) => {
  ...
  if (event.isPast) kicker = event.isPrevious ? constants.kicker.previous : constants.kicker.past
  if (event.isFuture) kicker = event.isNext ? constants.kicker.next : constants.kicker.future
